...
const Top2BookableDaysCard = ({ index, item }: any) => {
    ...
    <View>
      <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
        <View style={styles.row}>
          <FontAwesome5 name="calendar" style={{ color: iconColor5 }} />
          <Text style={[externalStyles.label, { marginLeft: 8 }]}>Day :</Text>
...
export default Top2BookableDaysCard;
